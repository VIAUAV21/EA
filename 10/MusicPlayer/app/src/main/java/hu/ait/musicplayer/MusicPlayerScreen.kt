...
fun MusicPlayerScreen(
    mediaPlayerViewModel: MusicPlayerViewModel = viewModel(factory = MusicPlayerViewModel.factory)
) {
    ...
    Column() {
        ...
        Slider(value = mediaPlayerViewModel.mediaProgress.value,
            ...
            onValueChange = {
                ...
                mediaPlayerViewModel.mediaPlayer.seekTo(mediaPlayerViewModel.mediaProgress.value.toInt())
            })
    }
}