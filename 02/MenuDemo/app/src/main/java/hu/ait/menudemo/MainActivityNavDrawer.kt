...
import hu.ait.menudemo.databinding.ActivityMainNavDrawerBinding
...
private lateinit var binding: ActivityMainNavDrawerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     setContentView(binding.root)
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_main_activity_nav_drawer)
