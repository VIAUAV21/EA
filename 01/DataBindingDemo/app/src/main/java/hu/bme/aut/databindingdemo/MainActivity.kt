...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.cityName = "Demo"



        btnShuffle.setOnClickListener {
            val newUser = User(FIRST_NAMES.getRandomElement(), LAST_NAMES.getRandomElement())
            binding.user = newUser

            binding.toastName = newUser.firstName
        }

        btnShowBindingValue.setOnClickListener {
